...
const routes: Routes = [
  ...
  { path: 'manager-card', component: ManagerCardComponent, canActivate:[AuthGuard]},
  { path: 'manager-personalization', component:ManagerPersonalizationComponent, canActivate:[AuthGuard]},
